...
public class ActivityListAdapter extends RecyclerView.Adapter<ActivityListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        bundle.putString("factor", mActivityList.get(position).getFactor());
        ...
        if(mActivityList.get(position).isLocked()) {
            ...
            holder.mActivityCardView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    DialogActivityManager dialogActivityManager = new DialogActivityManager(mContext, bundle, activityStatus);
